...
Started: Thu May 21 02:47:31 AM UTC 2026
Hostname: detection-lab
Branch at start: lab/automation-runner
HEAD at start: 61749fa
...
```
Result: COMPLETED at Thu May 21 02:47:31 AM UTC 2026
...
========================================================================
verify_corpus.py v1
Timestamp: 2026-05-21T02:47:31+00:00
========================================================================
...
Report written: reports/integrity/2026-05-21_024731_verify.json
...
Run ID: 2026-05-21_024732_acroform_self_laneA
========================================================================
Benchmarking ca_dmv_reg256                  ... P=1.0000 R=1.0000 F1=1.0000 (TP=  72 FP=  0 FN=  0) [PERFECT] 0.02s
Benchmarking irs_1040                       ... P=1.0000 R=1.0000 F1=1.0000 (TP= 199 FP=  0 FN=  0) [PERFECT] 0.01s
...
Reports written to: reports/benchmarks/2026-05-21_024732_acroform_self_laneA
...
Ground truth dir: /home/lab/detection-lab/benchmarks/ground_truth
PDFs to benchmark: 30
Run ID: 2026-05-21_024732_heuristic_lab_v1_laneA
========================================================================
Benchmarking ca_dmv_reg256                  ... P=0.8929 R=0.3472 F1=0.5000 (TP=  25 FP=  3 FN= 47) [low-recall] 0.23s
...
Benchmarking irs_w4                         ... P=0.4167 R=0.5208 F1=0.4630 (TP=  25 FP= 35 FN= 23) [OK] 0.70s
Benchmarking irs_w9                         ... P=0.3704 R=0.4348 F1=0.4000 (TP=  10 FP= 17 FN= 13) [low-recall] 0.68s
...
Benchmarking local_ss_5                     ... P=0.5686 R=0.4143 F1=0.4793 (TP=  29 FP= 22 FN= 41) [low-recall] 0.33s
Benchmarking local_sts_033                  ... P=0.9057 R=0.5581 F1=0.6906 (TP=  48 FP=  5 FN= 38) [OK] 0.24s
Benchmarking nj_mvc_ba49                    ... P=0.0000 R=0.0000 F1=0.0000 (TP=   0 FP=  0 FN= 58) [low-recall] 0.17s
Benchmarking ny_dtf_it201                   ... P=0.4268 R=0.1502 F1=0.2222 (TP=  35 FP= 47 FN=198) [low-recall] 0.53s
...
Benchmarking uscis_i9                       ... P=0.4545 R=0.0385 F1=0.0709 (TP=   5 FP=  6 FN=125) [low-recall] 0.49s
Benchmarking uscis_i90                      ... P=0.8351 R=0.4154 F1=0.5548 (TP=  81 FP= 16 FN=114) [low-recall] 0.39s
Benchmarking uscis_n400                     ... P=0.9803 R=0.4523 F1=0.6190 (TP= 199 FP=  4 FN=241) [low-recall] 0.87s
Benchmarking uscourts_ao240                 ... P=0.8000 R=0.2353 F1=0.3636 (TP=   8 FP=  2 FN= 26) [low-recall] 0.05s
Benchmarking uscourts_b101                  ... P=0.3186 R=0.1463 F1=0.2006 (TP=  36 FP= 77 FN=210) [low-recall] 1.03s
Benchmarking va_1010ez                      ... P=0.9610 R=0.4901 F1=0.6491 (TP=  74 FP=  3 FN= 77) [low-recall] 0.58s
Benchmarking va_21526ez                     ... P=0.9029 R=0.2397 F1=0.3788 (TP=  93 FP= 10 FN=295) [low-recall] 1.21s
========================================================================
PDFs processed: 30
...
Reports written to: reports/benchmarks/2026-05-21_024732_heuristic_lab_v1_laneA
...
$ /home/lab/detection-lab/.venv/bin/python scripts/compare_to_baseline.py --baseline 2026-05-21_024732_acroform_self_laneA --candidate 2026-05-21_024732_heuristic_lab_v1_laneA
========================================================================
compare_to_baseline.py
Baseline:  reports/benchmarks/2026-05-21_024732_acroform_self_laneA
Candidate: reports/benchmarks/2026-05-21_024732_heuristic_lab_v1_laneA
...
Reports written: reports/comparisons/2026-05-21_024743_vs_baseline/
  - comparison.json
  - comparison.csv
  - comparison.md
Latest summary: reports/latest/summary.md
```
Result: COMPLETED at Thu May 21 02:47:43 AM UTC 2026

## Render flat-PDF GT draft overlays
Started: Thu May 21 02:47:43 AM UTC 2026
```
...
M  overnight_runner.sh
 M reports/latest/lane_a_scorecard.md
 M reports/latest/regressions.md
 M reports/latest/summary.md
 M reports/overnight_status.md
```

## Final commit log
```
61749fa feat(lab): add deterministic overnight runner
c7138b8 feat(lab): overnight bash runner for deterministic queue execution
66ed87b docs(lab): overnight status report
...
Completed: Thu May 21 02:47:43 AM UTC 2026
