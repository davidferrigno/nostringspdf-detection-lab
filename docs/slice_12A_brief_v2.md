...
These are real issues but explicitly NOT this slice. If you have time after the 11 scenarios pass, create or append `docs/editor_ux_backlog.md` with these items. Do NOT implement them:
